...
val TRYOUT_CHIPS: List<SkillTryOutChip> =
  listOf(
    SkillTryOutChip(
      ...
      label = "I can share",
      prompt = "I have something to share with my community.",
      skillName = "community-offer",
    ),
    SkillTryOutChip(
      icon = Icons.Outlined.HelpOutline,
      label = "I need something",
      prompt = "I need something from my community.",
      skillName = "community-need",
    ),
    SkillTryOutChip(
      icon = Icons.Outlined.Groups,
      label = "How is my community?",
      prompt = "How is my community doing?",
      skillName = "community-pulse",
    ),
    SkillTryOutChip(
      icon = Icons.Outlined.MarkEmailUnread,
      label = "Any new matches?",
      prompt = "Are there any new matches or messages for me?",
      skillName = "community-inbox",
    ),
  )
